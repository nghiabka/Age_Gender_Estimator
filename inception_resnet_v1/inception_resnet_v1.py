...
def inference(images: object, keep_probability: object, phase_train: object = True, bottleneck_layer_size: object = 128, weight_decay: object = 0.0,
              reuse: object = None) -> object:
